...
enum TokenType {
    ...
    TYPE_INT, TYPE_LONG, TYPE_STRING, TYPE_BOOL, TYPE_DOUBLE, TYPE_FLOAT, CONST,
    IF, ELSE, WHILE, FOR, IN, FUNC, RETURN, BREAK, CONTINUE, TRY, CATCH, INCLUDE,
    DOT_CALL,
    EQUALS, NOT_EQUALS, ASSIGN, ARROW, PLUS_ASSIGN, MINUS_ASSIGN, STAR_ASSIGN, SLASH_ASSIGN, PERCENT_ASSIGN, INCREMENT, DECREMENT, QUESTION, COLON,
